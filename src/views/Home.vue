<template>
  <div>
    <section class="landing">
      <h1 class="landing-brand-h1">{{ $t('welcome.title') }}</h1>
      <h2 class="landing-brand-h2">{{ $t('welcome.slogan') }}</h2>
      <div class="landing-action-bar">
        <el-button @click="order">
          <i class="fas el-icon-fa-shipping-fast"></i>
